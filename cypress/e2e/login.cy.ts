describe('Login Functionality', () => {
    ...
    it('should log in successfully with valid credentials', () => {
        ...
        cy.get('input[placeholder="Enter your email"]').type(VALID_EMAIL).should('have.value', VALID_EMAIL);
        
        // --- 2. Type Password
        cy.get('input[placeholder="Enter your password"]').click();
        cy.get('input[placeholder="Enter your password"]').type(VALID_PASSWORD).should('have.value', VALID_PASSWORD);
    ...
    it('should show an error for an invalid email format', () => {
        ...
        cy.get('input[placeholder="Enter your email"]').click()
        cy.get('input[placeholder="Enter your email"]').type(INVALID_EMAIL).should('have.value', INVALID_EMAIL);
    ...
    it('should show a popup error for invalid credentials', () => {
        ...
        cy.get('input[placeholder="Enter your password"]').click();
        cy.get('input[placeholder="Enter your password"]').type(INVALID_PASSWORD).should('have.value', INVALID_PASSWORD);
